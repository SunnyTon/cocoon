...
discover=unittest.defaultTestLoader.discover(test_dir,pattern='/case/test_*.py')
...
fp=open(result,'wb') # wb方式写入 python3以下使用file()
runner = HTMLTestRunner.HTMLTestRunner(stream=fp,
                                       title='测试报告',
                                       description='erp_api项目用例执行情况')  #构造runner
